package com.toly1994.toly_test.random;
...
public class ZRandom {
    ...
    public static String randomChar(int max) {
        ...
        return randomChar(concat, max);
    }

    public static String randomChar(String[] strs, int max) {
        return randomChar(strs, 1, max);
    }

    public static String randomChar(String[] strs) {
        return strs[rangeInt(0,strs.length-1)];
    }
     ...
     * @return String
     */
    public static String randomChar(String[] strs, int min, int max) {
        min = min < 0 ? 0 : min;
        return rangeChar(rangeInt(min, max), strs);
    }
