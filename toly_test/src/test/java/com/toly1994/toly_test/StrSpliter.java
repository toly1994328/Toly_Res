...
import com.toly1994.toly_test.bean.Hero;
import com.toly1994.toly_test.bean.Movie;
import com.toly1994.toly_test.commom.StrUtils;
...
public class StrSpliter {
    ...
    public void juzi() {
        ...
        StringBuilder sb = new StringBuilder("public static String[] " + "SEN_CONG_CONG" + " = new String[]{");
        for (int i = 0; i < strings.length; i++) {
            String result = strings[i].replaceAll("\\s", "");
    ...
    public void juzi_HTYS() {
        //你的布局xml所在路径
        File file = new File("C:\\Users\\Administrator\\Desktop\\荷塘月色.txt");
        String readFile = readFile(file);
        String[] strings = readFile.split("。|\\.|？|\\?|！|!");
        StringBuilder sb = new StringBuilder("public static String[] " + "SEN_HTYS" + " = new String[]{");
        for (int i = 0; i < strings.length; i++) {
            String result = strings[i].replaceAll("\\s|　　", "");
    ...
    public void shz() {
        ...
        File file = new File("C:\\Users\\Administrator\\Desktop\\水浒传人物.txt");
    ...
    public void book() {
        ...
        Pattern pattern = Pattern.compile("《(?<result>.*?)》");//?<result>是取了一个组名
...
//        createIntArray("RES_BG", "bg_", 12);
//        createIntArray("REA_HEAD_ICON", "icon_", 90);
        createIntArray("REA_PIC", "pic_", 40);
    }

    public void createIntArray(String name, String preFix, int count) {
        StringBuilder sb = new StringBuilder("public static " + "int" + "[] " + name + " = new " + "int" + "[]{");
